...
public class PlayerWeaponUpgradeBehaviour : MonoBehaviour
{
    ...
    // [Header("WeaponBehaviour Upgrades")]
    ...
    [Header("WeaponBehaviour Lists")]
    public List<BaseWeaponType> activeWeapons = new List<BaseWeaponType>();
    public List<GameObject> playerWeapons = new List<GameObject>();
    
    private Dictionary<BaseWeaponType, WeaponBehaviour> weaponTypeDictionary = new Dictionary<BaseWeaponType, WeaponBehaviour>();
    ...
    {
        weaponTypeDictionary = new Dictionary<BaseWeaponType, WeaponBehaviour>
        {
    ...
    private void ApplyWeaponUpgrade(WeaponBehaviour weapon, UpgradeObject upgrade)
    {
